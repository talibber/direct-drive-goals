...
import { RotateCcw, Calendar, CheckCircle2, Clock, Send } from "lucide-react";
          ...
          {session.completed && (
            <div className="rounded-lg border border-success/30 bg-success/5 p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                What is your one commitment coming out of this session? Required within 24 hours of session completion.
              </p>
              <textarea
                value={commitment}
