...
const steps = [
  { icon: ClipboardCheck, title: "1. Apply", desc: "Fill out our application. Tell us who you are, what you're working on, and what's not working. We'll review within 48 hours." },
